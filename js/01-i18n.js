...
const I18N={
  ko:{
    ...
    aiPeriodToday:'오늘',aiPeriodWeek:'이번 주',aiPeriodMonth:'이번 달',aiPeriodCustom:'직접 선택',
    aiStyleDaily:'일일',aiStyleResume:'이력서용',aiStyleBusiness:'보고용',aiStyleLinkedIn:'LinkedIn용',
    aiDateFrom:'시작일',aiDateTo:'종료일',
    ...
    profileTitle:'프로필',uploadAvatar:'프로필 사진',userName:'이름',saveProfile:'저장',deleteAvatar:'사진 삭제',
  ...
  en:{
    ...
    aiPeriodToday:'Today',aiPeriodWeek:'This Week',aiPeriodMonth:'This Month',aiPeriodCustom:'Custom',
    aiStyleDaily:'Daily',aiStyleResume:'Resume',aiStyleBusiness:'Business',aiStyleLinkedIn:'LinkedIn',
    aiDateFrom:'From',aiDateTo:'To',
    ...
    profileTitle:'Profile',uploadAvatar:'Profile Picture',userName:'Name',saveProfile:'Save',deleteAvatar:'Remove Photo',
